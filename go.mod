module github.com/pedronis/ifacetool
...
require (
	github.com/snapcore/snapd v0.0.0-20260331144956-d3e713beb37f
...
require (
	...
	github.com/snapcore/secboot v0.0.0-20260302105957-77bc2457cc76 // indirect
